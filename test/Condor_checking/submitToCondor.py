...
outpath = '/eos/user/m/moameen/store'
...
for i in range(1,njobs+1):
    ...
    for line in lines:
        writeline = line.replace('FILENAME','file:/eos/user/m/moameen/store/onlyCA_pPb_HepMC_{i}.dat'.format(i=i))
...
requirements = (OpSysAndVer =?= "SLCern7")
