...
process.source = cms.Source("MCFileSource",
    fileNames = cms.untracked.vstring('file:/eos/cms/store/group/phys_heavyions/osuranyi/ZDC_singleNeutrons/cascade/cascade_pPb_HepMC_172.dat')
...
process.RandomNumberGeneratorService.g4SimHits.initialSeed = cms.untracked.uint32(106665094)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('/eos/cms/store/group/phys_heavyions/osuranyi/ZDC_output/cascade/file_172.root')
)
