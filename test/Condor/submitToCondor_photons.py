...
outpath = '/eos/cms/store/group/phys_heavyions/osuranyi/ZDC_output/photons/'
os.system('rm -rf '+outpath)
os.system('mkdir -p '+outpath)

allfiles = []

logdir = 'submission_photons'
...
for i in range(1,njobs+1):
    ...
    for line in lines:
        writeline = line.replace('FILENAME','file:/eos/cms/store/group/phys_heavyions/osuranyi/ZDC_singleNeutrons/photons/photons_pPb_HepMC_{i}.dat'.format(i=i))
        writeline = line.replace('OUTPUT',str(tmp_out))
