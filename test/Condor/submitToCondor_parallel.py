...
outpath = '/eos/cms/store/group/phys_heavyions/osuranyi/ZDC_output/parallel/'
os.system('rm -rf '+outpath)
os.system('mkdir -p '+outpath)

allfiles = []

logdir = 'submission_parallel'
...
for i in range(1,njobs+1):
    ...
    for line in lines:
        writeline = line.replace('FILENAME','file:/eos/cms/store/group/phys_heavyions/osuranyi/ZDC_singleNeutrons/parallel/parallel_pPb_HepMC_{i}.dat'.format(i=i))
