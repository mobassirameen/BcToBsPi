...
process.source = cms.Source("MCFileSource",
    fileNames = cms.untracked.vstring('file:/eos/cms/store/group/phys_heavyions/osuranyi/ZDC_singleNeutrons/parallel/parallel_pPb_HepMC_485.dat')
...
process.RandomNumberGeneratorService.g4SimHits.initialSeed = cms.untracked.uint32(292799398)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('/eos/cms/store/group/phys_heavyions/osuranyi/ZDC_output/parallel/file_485.root')
)
